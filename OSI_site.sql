...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 23 2023 г., 07:53
...
(1, 0, 'Ваш любимый цвет? (подсказка: прозрачный)', 'Красный|Синий|Зелёный|Чёрный|Нет цвета', 5),
(2, 0, 'С помощью какого слова можно вывести строку на сайт или в консоль?', 'echo|and|error|session_start', 1),
(3, 1, 'В чём суть текста \"lorem ipsum\"?', 'Тайное послание|Текст-заглушка|Смысл жизни на древнем языке', 2),
(4, 1, 'Просто выберите 4 вариант ответа.', 'Это первый вариант|Третий врёт|Четвёртый здесь|Во втором правда', 4);
